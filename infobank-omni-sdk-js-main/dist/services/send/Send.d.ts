...
export declare class Send {
     ...
     * @returns
     */
    SMS(req: SMSRequestBody): Promise<IResponseBody>;
    /**
     * Method: MMS
     ...
     * @returnsparam
     */
    MMS(req: MMSRequestBody): Promise<IResponseBody>;
    /**
     ...
     * @returnsparam
     */
    International(req: InternationalRequestBody): Promise<IResponseBody>;
    /**
     * Method: RCS
     ...
     * @returnsparam
     */
    RCS(req: RCSRequestBody): Promise<IResponseBody>;
    /**
     * Method: Alimtalk
     ...
     * @returnsparam
     */
    Alimtalk(body: AlimtalkRequestBody): Promise<IResponseBody>;
    /**
     * Method: Friendtalk
     ...
     * @returnsparam
     */
    Friendtalk(body: FriendtalkRequestBody): Promise<IResponseBody>;
    /**
    * Method: BrandMessage
    ...
    * @returnsparam
    */
    BrandMessage(body: BrandMessageRequestBody): Promise<IResponseBody>;
    /**
     * Method: OMNI
     ...
     * @returnsparam
     */
    OMNI(body: OMNIRequestBody): Promise<IResponseBody>;
    /**
     * Method: sendRequest
